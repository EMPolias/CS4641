...
# Training trees of different degrees
# degrees = range(1, 10)
...
##### SENTIMENT DATASET #####
# Training trees of different bag_sizes (fixed max_depth=8)
# MAX_BAG_SIZE = 17499
...
# Training trees of different training set sizes (fixed max_depth=35)
