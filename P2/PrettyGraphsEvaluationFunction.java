...
public class PrettyGraphsEvaluationFunction implements EvaluationFunction {
    ...
    protected static final int GAP = 70;
    ...
    public double score(Boolean printDiagnosis) {
        ...
        if (printDiagnosis) {
            System.out.println("area: " + areaScore + " / " + areaM);
            System.out.println("edgeVarScore: " + edgeVarScore + " / " + edgeVarM);
            System.out.println("edgeDistScore: " + edgeDistScore + " / " + edgeDistM);
            System.out.println("intersectScore: " + intersectScore + " / " + intersM);
            System.out.println("edgeLenScore: " + edgeLenScore + " / " + edgeLenM);
            System.out.println("overlapScore: " + overlapScore + " / " + overlapM);
        }
